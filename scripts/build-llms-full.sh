...
PROVIDER_REF="$ROOT/lium/references/provider.md"

for f in "$SKILL" "$CLI_REF" "$SDK_REF" "$PROVIDER_REF"; do
...

{
  ...
  echo
  echo "Self-contained reference for AI agents. Includes skill overview, CLI command reference, Python SDK reference, and the provider journey for agents."
